-- MIGRACIÓN COMPLETA: Crear/Actualizar tabla Place (VERSIÓN CORREGIDA)
-- Este script maneja ambos casos: si existe University o si no existe ninguna tabla
-- Ejecuta este script en Supabase SQL Editor
-- IMPORTANTE: Ejecuta TODO el script de una vez, pero el enum se maneja en pasos separados
...
-- Paso 6: Agregar valor 'place' al enum CommissionScope
-- NOTA: Este paso se ejecuta primero y se commiteará automáticamente
DO $$
BEGIN
  IF NOT EXISTS (
...
-- Paso 7: Actualizar registros existentes (EJECUTAR ESTO EN UNA QUERY SEPARADA DESPUÉS DEL PASO 6)
-- IMPORTANTE: Ejecuta esta línea en una nueva query después de que el paso 6 haya terminado
